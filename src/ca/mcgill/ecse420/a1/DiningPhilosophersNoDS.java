...
public class DiningPhilosophersNoDS {
  ...
  public static void main(String[] args) {
    ...
    for (int i = 0; i < philosophers.length; i++) {
      ...
      //To fix the deadlock, we must make one of the philosophers start by taking the right chopstick
...
//        }
  ...
  public static class Chopstick {
    ...
    //The thread that has currently the longest wait time will be awarded the lock, fixing our starvation issue.

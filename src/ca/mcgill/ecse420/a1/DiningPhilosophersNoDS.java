...
// This version of DiningPhilosophers fixes the deadlock and starvation issues.
public class DiningPhilosophersNoDS {
  ...
  public static class Chopstick {
    ...
    // By putting true, the lock will be awarded based on fairness.
    // The thread that has currently the longest wait time will be awarded the lock,
    // fixing our starvation issue.
